...
#
# Generated by export_simulation on Tue Jan 06 21:10:57 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './sum.sh' script.
...
./sum.sh -noclean_files

For more information on the script, please type './sum.sh -help'.
